...
with dask.config.set(**{'array.slicing.split_large_chunks': True}):
    _, inputs_train, coords_train, char_train, lb_train = make_nninputs(ds,tags, time_ind, k_ind, j_ind, i_ind, 1)
...
if __name__ == "__main__": 
    ...
    model = PhysicsInformedNN(inputs_train, char_train, lb_train, col_train, inputs_val, layers, f_col, 0.9)
    ...
    ## SAVING THE MODEL
    ckpt_file = "/scratch/gpfs/wc4720/SOCCOM/saved-models/model-gamma-1/latlon_k2037_j4070_i4070_gamma10_iter16000_layer20_gamma90_run5.ckpt"
    array_file = "/scratch/gpfs/wc4720/SOCCOM/saved-models/model-gamma-1/latlon_k2037_j4070_i4070_gamma10_iter16000_layer20_gamma90_run5.npz"
