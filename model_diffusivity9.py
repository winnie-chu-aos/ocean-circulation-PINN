...
#         self.rho_v = val_nn[:,10:11]
        ...
        self.optimizer = tf.contrib.opt.ScipyOptimizerInterface(self.loss, 
                                                                method = 'L-BFGS-B', 
                                                                options = {'maxiter': 10000,  # original maxiter is 50000
                                                                           'maxfun': 50000,
                                                                           'maxcor': 25,
                                                                           'maxls': 25,
...
if __name__ == "__main__": 
    ...
    nIter = 1500 # number of Adams optimizer training iterations
    losses, eq_losses, data_losses, val_losses, temp_losses, salt_losses = model.train(nIter)

# SAVING THE MODEL
ckpt_file = "/scratch/gpfs/wc4720/SOCCOM/saved-models/diffusivity-noprho/latlon_k020_j4090_i300350_iter11500_layer20_gamma10_omitvel4.ckpt"
array_file = "/scratch/gpfs/wc4720/SOCCOM/saved-models/diffusivity-noprho/latlon_k020_j4090_i300350_iter11500_layer20_gamma10_omitvel4.npz"
