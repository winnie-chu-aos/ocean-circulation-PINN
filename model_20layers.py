...
for i in range(5):
    ...
    if __name__ == "__main__": 
        ...
        ## SAVING THE MODEL
        ckpt_file = "/scratch/gpfs/wc4720/SOCCOM/saved-models/model-complexity/latlon_k2037_j4070_i4070_gamma10_iter16000_layer20_run"+str(i+1)+".ckpt"
        array_file = "/scratch/gpfs/wc4720/SOCCOM/saved-models/model-complexity/latlon_k2037_j4070_i4070_gamma10_iter16000_layer20_run"+str(i+1)+".npz"
