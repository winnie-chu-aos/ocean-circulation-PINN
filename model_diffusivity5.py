...
# NEW VERSION OF THE NN FOCUSING ON TRACER CONSERVATION
class PhysicsInformedNN:
    ...
    def __init__(self, inputs_nn, char_nn, lb_nn, col_nn, val_nn, layers, f_nn, gamma):
        ...
        # training points
        self.u_pred, self.v_pred, self.w_pred, self.T_pred, self.S_pred = self.net_NS(self.t_tf, self.k_tf, self.j_tf, self.i_tf)

        # validation points
        self.u_val_pred, self.v_val_pred, self.w_val_pred, self.T_val_pred, self.S_val_pred = self.net_NS(self.t_vtf, self.k_vtf, self.j_vtf, self.i_vtf)

        # collocation points
        self.fcont, self.fT_pred, self.fS_pred = self.net_f_NS(self.t_ctf, self.k_ctf, self.j_ctf, self.i_ctf)
    ...
    def net_NS(self, t, k, j, i):
        ...
        return u_hat, v_hat, w_hat, T_hat, S_hat
    ...
    def train(self, nIter): 
        ...
        tf_dict = {self.i_tf: self.i, self.j_tf: self.j, self.k_tf: self.k, self.t_tf: self.t, self.S_tf: self.S, self.T_tf: self.T, self.u_tf: self.u, self.v_tf: self.v, self.w_tf: self.w,\
    ...
    def predict(self, t_star, k_star, j_star, i_star):
        ...
        return u_star, v_star, w_star, T_star, S_star, Kx_star, Ky_star, Kz_star
...
# SAVING THE MODEL
ckpt_file = "/scratch/gpfs/wc4720/SOCCOM/saved-models/diffusivity-noprho/latlon_k020_j4090_i300350_iter2500_layer20_gamma10.ckpt"
array_file = "/scratch/gpfs/wc4720/SOCCOM/saved-models/diffusivity-noprho/latlon_k020_j4090_i300350_iter2500_layer20_gamma10.npz"
