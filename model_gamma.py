...
if __name__ == "__main__": 
    ...
    # model = PhysicsInformedNN(inputs_train, char_train, lb_train, col_train, inputs_val, layers, f_col, gamma_input)
    model = PhysicsInformedNN(inputs_train, char_train, lb_train, inputs_test[:,0:4].squeeze(), inputs_val, layers, f_test, gamma_input)
