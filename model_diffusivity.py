...
class PhysicsInformedNN:
    ...
    def net_f_NS(self, t, k, j, i):
        ...
        fT = char_nn[3]/char_nn[4]*(char_nn[4]/char_nn[0]*T_t + char_nn[4]/char_nn[3]*u_full*T_x + char_nn[4]/char_nn[2]*v_full*T_y + char_nn[4]/char_nn[1]*w_full*T_z - Kx*char_nn[4]/char_nn[3]**2*T_xx - Kx*char_nn[4]/char_nn[2]**2*T_yy - Kz*char_nn[4]/char_nn[1]**2*T_zz) 
        
        # salinity conservation
        fS = char_nn[3]/char_nn[5]*(char_nn[5]/char_nn[0]*T_t + char_nn[5]/char_nn[3]*u_full*S_x + char_nn[5]/char_nn[2]*v_full*S_y + char_nn[5]/char_nn[1]*w_full*S_z - Kx*char_nn[5]/char_nn[3]**2*S_xx - Kx*char_nn[5]/char_nn[2]**2*S_yy - Kz*char_nn[5]/char_nn[1]**2*S_zz) 
...
if __name__ == "__main__": 
    ...
    ## SAVING THE MODEL
    ckpt_file = "/scratch/gpfs/wc4720/SOCCOM/saved-models/mega-runs/latlon_k2030_j4575_i300400_iter145000_layer20_gamma10_diffusivity.ckpt"
    array_file = "/scratch/gpfs/wc4720/SOCCOM/saved-models/mega-runs/latlon_k2030_j4575_i300400_iter145000_layer20_gamma10_diffusivity.npz"
